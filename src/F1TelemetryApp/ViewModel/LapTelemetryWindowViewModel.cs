...
public class LapTelemetryWindowViewModel : BasePageViewModel
{
    ...
    //private ObservableCollection<Model.Lap> _laps;
    //public ObservableCollection<Model.Lap> Laps
    //{
    //    get => _laps;
    //    set
    //    {
    ...
    //private Model.Lap _displayedLap;
    //public Model.Lap DisplayedLap
    //{
    //    get => _displayedLap;
    //    set
    //    {
    ...
    //    App.Current.Dispatcher.Invoke(() =>
    //    {
    //        var lap = new Model.LapData(myLapData.currentLapNum, myLapData.currentLapTime, myLapData.lapDistance);
    //        UpdateLap(lap);
    ...
    //    UpdateLap(new Model.Lap(lapNumber));
    //    DisplayedLap = Laps[DisplayedLapIndex];
    //}

    //public void RedrawLaps()
    //{
    //    var laps = new ObservableCollection<Model.Lap>();
    ...
    //private void UpdateLap(Model.Lap lap)
    //{
